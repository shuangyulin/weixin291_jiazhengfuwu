<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="链接网站" prop="lianjiewangzhan">
          <el-input v-model="ruleForm.lianjiewangzhan" 
              placeholder="链接网站" clearable  :readonly="ro.lianjiewangzhan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="链接网站" prop="lianjiewangzhan">
              <el-input v-model="ruleForm.lianjiewangzhan" 
                placeholder="链接网站" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianjiemingcheng = true;
          ...
          if(o=='lianjiewangzhan'){
            this.ruleForm.lianjiewangzhan = obj[o];
	    this.ro.lianjiewangzhan = true;
            continue;
          }
          if(o=='tupian'){
